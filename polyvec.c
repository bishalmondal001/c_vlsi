...
#pragma HLS ARRAY_PARTITION variable=r type=cyclic factor=11
  uint16_t t[8];
...
#if (KYBER_POLYVECCOMPRESSEDBYTES == (KYBER_K * 352))
#pragma HLS ARRAY_PARTITION variable=a type=cyclic factor=11
  uint16_t t[8];
...
#elif (KYBER_POLYVECCOMPRESSEDBYTES == (KYBER_K * 320))
#pragma HLS ARRAY_PARTITION variable=a type=cyclic factor=5
  uint16_t t[4];
#pragma HLS ARRAY_PARTITION variable=t type=cyclic factor=4
  for(i=0;i<KYBER_K;i++) {
#pragma HLS PIPELINE II=25
    for(j=0;j<KYBER_N/4;j++) {
